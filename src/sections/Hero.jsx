...
function Hero() {
  return (
    <div className='px-(--mx-sm) md:px-(--mx-md) lg:px-(--mx-lg) xl:px-(--mx-xl)'>
      <div className='h-max  mt-[293px] grid grid-flow-row grid-cols-1  gap-4 md:grid-cols-4 md:gap-y-11 md:gap-x-22 lg:gap-y-4 lg:grid-cols-5 xl:gap-y-4 items-center   text-(--color-bg-secondary) md:mt-85 lg:mt-[49px] xl:mt-[77px] xl:mx-5 max-w-screen mx-auto'>
    ...
    md:col-span-full md:row-start-2 lg:row-start-3 text-[74px] leading-[90.2px] lg:leading-[246.4px] md:text-[154px]  lg:text-[224px] 2xl:text-[284px] xl:row-end-5  font-bold font-(family-name:--font-header) xl:text-nowrap'>
          Bletzertt
        </h1>
        <div
    ...
    lg:col-span-2 lg:col-start-1 lg:col-end-4  xl:col-start-1 xl:col-end-3'>
          ...
          <p className='text-base font-medium xl:text-lg lg:text-lg md:w-[405px]'>
